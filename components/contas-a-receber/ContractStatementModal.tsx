...
export function ContractStatementModal({ isOpen, onClose, contractId, contractTitle }: ContractStatementModalProps) {
  ...
  const fetchPayments = async () => {
    ...
    // Busca todas as parcelas deste contrato com seus respectivos pagamentos (se existirem)
    ...
    // Filtra para mostrar apenas as parcelas efetivamente pagas (se necessário, mas parecer que deve mostrar pagamentos)
