-- Corrigir o sistema de auditoria para suportar IDs UUID (como os do Kanban e Marketing)
-- O erro ocorre porque record_id na tabela audit_logs é BIGINT, mas novas tabelas usam UUID.

-- 1. Alterar a coluna record_id para TEXT para suportar tanto BIGINT quanto UUID
