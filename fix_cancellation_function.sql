...
BEGIN
  ...
  -- ALERTA: Permitindo cancelamento de parcelas 'Prorrogada', 'Prorrogado', ou 'Estornado' desde que amountPaid = 0
  SELECT COALESCE(bool_or("amountPaid" > 0 OR lower(status) NOT IN ('aberto', 'atrasada', 'prorrogada', 'prorrogado', 'estornado')), false) INTO v_has_payments 
  FROM installments 
