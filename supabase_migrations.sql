-- 0. Helper function to execute SQL
...
BEGIN
  ...
  SELECT COALESCE(bool_or("amountPaid" > 0 OR lower(status) NOT IN ('aberto', 'atrasada', 'prorrogada', 'prorrogado', 'cancelada')), false) INTO v_has_payments 
  FROM installments 
  WHERE contract_id = p_contract_id;
  
  -- Permite cancelamento se não houver pagamentos, ignorando status de parcelas se forem prorrogadas ou abertas
  -- A lógica foi ajustada para permitir que contratos com parcelas 'prorrogada' ou 'prorrogado' sejam cancelados se não houver pagamentos.
  -- O erro estava na verificação do status das parcelas.
